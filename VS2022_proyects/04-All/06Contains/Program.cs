    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var pets = new[]
           {
            ...
            Console.WriteLine(isPresentHannibal); //    False
            bool isPresentHannibal2 = pets.Contains(pets[0]);
            Console.WriteLine(isPresentHannibal2); //   True
            ...
            Console.WriteLine(ContainsBannedWords2(words, bannedWords));
        ...
        //  Con linQ
        public static bool ContainsBannedWords2(IEnumerable<string> words, IEnumerable<string> bannedWords)
        {
            return words.Any(item => bannedWords.Contains(item));
        }
