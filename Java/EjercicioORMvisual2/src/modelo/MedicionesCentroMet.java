...
public class MedicionesCentroMet implements java.io.Serializable {
	...
	public MedicionesCentroMet(MedicionesCentroMetId id) {
		this.id = id;
	}

	public MedicionesCentroMet(MedicionesCentroMetId id, Integer dirViento, Integer HRelativa, Float PAtmosferica,
			Float precip, Float radSolar, Float tempAmbiente, Float VViento, String ica) {
		this.id = id;
